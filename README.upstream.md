> **Note / 说明**
> This is the original upstream ORBTrace README, preserved verbatim.
> 这是上游 ORBTrace 项目的原始 README，原文保留。
> Fork-specific (Artix-7 port) documentation lives in the top-level [`README.md`](README.md).
> 本 fork（Artix-7 移植）的说明见顶层 [`README.md`](README.md)。
