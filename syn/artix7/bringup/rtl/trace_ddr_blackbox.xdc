# trace_ddr_blackbox_top constraints — A7-Lite (XC7A35T-FGG484).
# Ethernet + trace-capture pins + LEDs + sys clk/reset. DDR3 pins from MIG IP.
...
# TRACECLK input clock (constrain worst-case fast; direct capture is freq-indep)
create_clock -period 20.000 -name trace_clk_in [get_ports trace_clk_in]
