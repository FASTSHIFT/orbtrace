...
#   cd build && vivado -mode batch -source ../run_net_test.tcl
...
# is forked locally as bringup/fpga_core_net.v with A7-Lite IP + RGMII TX
...
read_verilog $bdir/net_test_top.v
read_xdc      $bdir/net_test.xdc
